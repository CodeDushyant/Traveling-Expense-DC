import EtawahImage from "./assets/Etawah.jpg";
...
const data = [
	...
	},
	{
		id: 8,
		name: "Etawah",
		info: "Etawah is a city in the Indian state of Uttar Pradesh, known for its historical significance and cultural heritage. The city is home to several ancient temples, forts, and wildlife sanctuaries, as well as a rich agricultural tradition that thrives on fertile plains. Etawah is also famous for its association with the Chambal ravines and its contributions to politics and history.",
		image: EtawahImage,
		price: "98,990",
	},
];
